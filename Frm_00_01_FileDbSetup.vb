Public Class Frm_00_01_FileDbSetup
    Private Sub DatabaseSettingsForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LoadSettingsToForm()
        If Me.Txt_01_serverAddr.Text = "" Or Me.Txt_02_serverPort.Text = "" Or Me.Txt_03_username.Text = "" Or Me.Txt_04_password.Text = "" Or Me.Txt_05_dbName.Text = "" Then
    ...
    Private Sub LoadSettingsToForm()
        Dim settings = Module_db.LoadSettings()
    ...
    Private Sub Btn_02_Test_Click(sender As Object, e As EventArgs) Handles Btn_02_Test.Click
        If Module_db.TestConnection() Then
    ...
    Private Sub Txt_01_serverAddr_ModifiedChanged(sender As Object, e As EventArgs) Handles Txt_01_serverAddr.ModifiedChanged
        Me.Btn_02_Test.Enabled = False
    End Sub

    Private Sub Txt_02_serverPort_ModifiedChanged(sender As Object, e As EventArgs) Handles Txt_02_serverPort.ModifiedChanged
        Me.Btn_02_Test.Enabled = False
    End Sub

    Private Sub Txt_03_username_ModifiedChanged(sender As Object, e As EventArgs) Handles Txt_03_username.ModifiedChanged
        Me.Btn_02_Test.Enabled = False
    End Sub

    Private Sub Txt_04_password_ModifiedChanged(sender As Object, e As EventArgs) Handles Txt_04_password.ModifiedChanged
        Me.Btn_02_Test.Enabled = False
    End Sub

    Private Sub Txt_05_dbName_ModifiedChanged(sender As Object, e As EventArgs) Handles Txt_05_dbName.ModifiedChanged
        Me.Btn_02_Test.Enabled = False
    End Sub

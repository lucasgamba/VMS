...
Partial Class Frm_02_00_LandingResto
    ...
    Private Sub InitializeComponent()
        ...
        ItemsSoldToolStripMenuItem = New ToolStripMenuItem()
        ...
        Ts_Tab_01_Main = New Syncfusion.Windows.Forms.Tools.ToolStripTabItem()
        Ts_Main_01_Cashier = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Main_Btn_01_Cashier_OpenClose = New ToolStripButton()
        Ts_Main_02_Orders = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        ...
        Ts_Main_03_Reservation = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Main_Btn_06_Reservation_Calendar = New ToolStripButton()
        Ts_Main_04_Customers = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        ...
        Ts_Mkt_01_Benefits = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Mkt_Btn_01_Benefits_Promotions = New ToolStripButton()
        Mkt_Btn_02_Benefits_Vouchers = New ToolStripButton()
        Ts_Mkt_02_Loyalty = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        ...
        Ts_Tab_04_Reports = New Syncfusion.Windows.Forms.Tools.ToolStripTabItem()
        Ts_Report_01_Sales = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        ...
        Ts_Report_02_Performance = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Report_Btn_03_Performance_Dashboard = New ToolStripButton()
        Ts_Report_03_Finance = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Report_Btn_04_Finance_Summary = New ToolStripButton()
        Report_Btn_05_Finance_CashHistory = New ToolStripButton()
        Ts_Report_04_Stock = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Report_Btn_06_Stock_InputsOutputs = New ToolStripButton()
        Report_Btn_07_Stock_PositionByDate = New ToolStripButton()
        Ts_Tab_05_Config = New Syncfusion.Windows.Forms.Tools.ToolStripTabItem()
        Ts_Config_01_Operational = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Config_Btn_01_General_Tables = New ToolStripButton()
        Config_Btn_02_General_Units = New ToolStripButton()
        Ts_Config_02_Personal = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        Config_Btn_03_Personal_Employee = New ToolStripButton()
        Config_Btn_04_Personal_Password = New ToolStripButton()
        Ts_Config_03_General = New Syncfusion.Windows.Forms.Tools.ToolStripEx()
        ...
        Ts_Tab_01_Main.Panel.SuspendLayout()
        Ts_Main_01_Cashier.SuspendLayout()
        Ts_Main_02_Orders.SuspendLayout()
        Ts_Main_03_Reservation.SuspendLayout()
        ...
        Ts_Mkt_01_Benefits.SuspendLayout()
        Ts_Mkt_02_Loyalty.SuspendLayout()
        Ts_Tab_04_Reports.Panel.SuspendLayout()
        ...
        Ts_Tab_05_Config.Panel.SuspendLayout()
        Ts_Config_01_Operational.SuspendLayout()
        Ts_Config_02_Personal.SuspendLayout()
        Ts_Config_03_General.SuspendLayout()
        SuspendLayout()
        ' 
        ' Logo_01
        ' 
        Logo_01.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom
        Logo_01.BackColor = Color.Transparent
        Logo_01.BackgroundImageLayout = ImageLayout.Stretch
        Logo_01.Location = New Point(513, 230)
        Logo_01.Margin = New Padding(3, 4, 3, 4)
        Logo_01.Name = "Logo_01"
        Logo_01.Size = New Size(355, 546)
        Logo_01.SizeMode = PictureBoxSizeMode.AutoSize
        Logo_01.TabIndex = 0
        Logo_01.TabStop = False
        ' 
        ' ToolStripButton1
        ' 
        ToolStripButton1.Font = New Font("Calibri", 9.75F)
        ToolStripButton1.Image = CType(resources.GetObject("ToolStripButton1.Image"), Image)
        ToolStripButton1.ImageScaling = ToolStripItemImageScaling.None
        ToolStripButton1.ImageTransparentColor = Color.Magenta
        ToolStripButton1.Name = "ToolStripButton1"
        ToolStripButton1.Padding = New Padding(15, 0, 15, 0)
        ToolStripButton1.Size = New Size(98, 83)
        ToolStripButton1.Text = "Top Sales"
        ToolStripButton1.TextImageRelation = TextImageRelation.ImageAboveText
        ' 
        ' ToolStripButton18
        ' 
        ToolStripButton18.DropDownItems.AddRange(New ToolStripItem() {OrdersToolStripMenuItem, ItemsSoldToolStripMenuItem, CashierHistoryToolStripMenuItem})
        ToolStripButton18.Font = New Font("Calibri", 9.75F)
        ToolStripButton18.Image = CType(resources.GetObject("ToolStripButton18.Image"), Image)
        ToolStripButton18.ImageScaling = ToolStripItemImageScaling.None
        ToolStripButton18.ImageTransparentColor = Color.Magenta
        ToolStripButton18.Name = "ToolStripButton18"
        ToolStripButton18.Padding = New Padding(15, 0, 15, 0)
        ToolStripButton18.Size = New Size(107, 83)
        ToolStripButton18.Text = "History"
        ToolStripButton18.TextImageRelation = TextImageRelation.ImageAboveText
        ' 
        ' OrdersToolStripMenuItem
        ' 
        OrdersToolStripMenuItem.Name = "OrdersToolStripMenuItem"
        OrdersToolStripMenuItem.Size = New Size(159, 22)
        OrdersToolStripMenuItem.Text = "Orders"
        ' 
        ' ItemsSoldToolStripMenuItem
        ' 
        ItemsSoldToolStripMenuItem.Name = "ItemsSoldToolStripMenuItem"
        ItemsSoldToolStripMenuItem.Size = New Size(159, 22)
        ItemsSoldToolStripMenuItem.Text = "Items Sold"
        ' 
        ' CashierHistoryToolStripMenuItem
        ' 
        CashierHistoryToolStripMenuItem.Name = "CashierHistoryToolStripMenuItem"
        CashierHistoryToolStripMenuItem.Size = New Size(159, 22)
        CashierHistoryToolStripMenuItem.Text = "Cashier History"
        ' 
        ' ToolStripDropDownButton1
        ' 
        ToolStripDropDownButton1.Font = New Font("Calibri", 9.75F)
        ...
        ToolStripDropDownButton1.Padding = New Padding(15, 0, 15, 0)
        ToolStripDropDownButton1.Size = New Size(127, 83)
        ToolStripDropDownButton1.Text = "Service Ranking"
        ...
        ToolStripButton2.Margin = New Padding(5, 2, 5, 2)
        ToolStripButton2.Name = "ToolStripButton2"
        ToolStripButton2.Padding = New Padding(15, 0, 15, 0)
        ToolStripButton2.Size = New Size(102, 86)
        ...
        RibbonControlAdv1.Header.AddMainItem(Ts_Tab_01_Main)
        RibbonControlAdv1.Header.AddMainItem(Ts_Tab_02_Products)
        RibbonControlAdv1.Header.AddMainItem(Ts_Tab_03_Marketing)
        RibbonControlAdv1.Header.AddMainItem(Ts_Tab_04_Reports)
        RibbonControlAdv1.Header.AddMainItem(Ts_Tab_05_Config)
        ...
        ' Ts_Tab_01_Main
        ' 
        Ts_Tab_01_Main.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Tab_01_Main.Name = "Ts_Tab_01_Main"
        ' 
        ' RibbonControlAdv1.RibbonPanel1
        ' 
        Ts_Tab_01_Main.Panel.CaptionFont = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Tab_01_Main.Panel.Controls.Add(Ts_Main_01_Cashier)
        Ts_Tab_01_Main.Panel.Controls.Add(Ts_Main_02_Orders)
        Ts_Tab_01_Main.Panel.Controls.Add(Ts_Main_03_Reservation)
        Ts_Tab_01_Main.Panel.Controls.Add(Ts_Main_04_Customers)
        Ts_Tab_01_Main.Panel.Controls.Add(Ts_Main_05_Logout)
        Ts_Tab_01_Main.Panel.Name = "RibbonPanel1"
        Ts_Tab_01_Main.Panel.ScrollPosition = 0
        Ts_Tab_01_Main.Panel.TabIndex = 2
        Ts_Tab_01_Main.Panel.Text = "Main"
        Ts_Tab_01_Main.Position = 0
        Ts_Tab_01_Main.Size = New Size(59, 25)
        RibbonControlAdv1.TabGroups.SetTabGroup(Ts_Tab_01_Main, Nothing)
        Ts_Tab_01_Main.Tag = "1"
        Ts_Tab_01_Main.Text = "Main"
        ' 
        ' Ts_Main_01_Cashier
        ' 
        Ts_Main_01_Cashier.Dock = DockStyle.None
        Ts_Main_01_Cashier.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Main_01_Cashier.ForeColor = Color.MidnightBlue
        Ts_Main_01_Cashier.GripStyle = ToolStripGripStyle.Hidden
        Ts_Main_01_Cashier.Image = Nothing
        ...
        Main_Btn_01_Cashier_OpenClose.Size = New Size(122, 102)
        ...
        ' Ts_Main_02_Orders
        ' 
        Ts_Main_02_Orders.Dock = DockStyle.None
        Ts_Main_02_Orders.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Main_02_Orders.ForeColor = Color.MidnightBlue
        ...
        Main_Btn_02_Orders_Tables.Size = New Size(98, 102)
        ...
        Main_Btn_03_Orders_Delivery.Size = New Size(98, 102)
        ...
        Main_Btn_04_Orders_DirectSales.Size = New Size(113, 102)
        ...
        Main_Btn_05_Orders_ClientOrder.Size = New Size(118, 102)
        ...
        ' 
        Ts_Main_03_Reservation.Dock = DockStyle.None
        Ts_Main_03_Reservation.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Main_03_Reservation.ForeColor = Color.MidnightBlue
        ...
        Main_Btn_06_Reservation_Calendar.Size = New Size(98, 102)
        ...
        ' 
        Ts_Main_04_Customers.Dock = DockStyle.None
        Ts_Main_04_Customers.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Main_04_Customers.ForeColor = Color.MidnightBlue
        ...
        Main_Btn_07_Customers_Clients.Size = New Size(98, 102)
        ...
        ' Ts_Main_05_Logout
        ' 
        Ts_Main_05_Logout.Dock = DockStyle.None
        Ts_Main_05_Logout.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Main_05_Logout.ForeColor = Color.MidnightBlue
        ...
        Main_Btn_08_Logout.Size = New Size(98, 102)
        Main_Btn_08_Logout.Text = "Logout"
        Main_Btn_08_Logout.TextImageRelation = TextImageRelation.ImageAboveText
        ' 
        ' Ts_Tab_02_Products
        ' 
        Ts_Tab_02_Products.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Tab_02_Products.Name = "Ts_Tab_02_Products"
        ' 
        ...
        Ts_Tab_02_Products.Panel.Text = "Products"
        Ts_Tab_02_Products.Position = 1
        Ts_Tab_02_Products.Size = New Size(82, 25)
        RibbonControlAdv1.TabGroups.SetTabGroup(Ts_Tab_02_Products, Nothing)
        ...
        ' Ts_Tab_03_Marketing
        ' 
        Ts_Tab_03_Marketing.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Tab_03_Marketing.Name = "Ts_Tab_03_Marketing"
        ' 
        ' RibbonControlAdv1.RibbonPanel3
        ' 
        Ts_Tab_03_Marketing.Panel.Controls.Add(Ts_Mkt_01_Benefits)
        Ts_Tab_03_Marketing.Panel.Controls.Add(Ts_Mkt_02_Loyalty)
        Ts_Tab_03_Marketing.Panel.Name = "RibbonPanel3"
        Ts_Tab_03_Marketing.Panel.ScrollPosition = 0
        Ts_Tab_03_Marketing.Panel.TabIndex = 4
        Ts_Tab_03_Marketing.Panel.Text = "Marketing"
        Ts_Tab_03_Marketing.Position = 2
        Ts_Tab_03_Marketing.Size = New Size(90, 25)
        RibbonControlAdv1.TabGroups.SetTabGroup(Ts_Tab_03_Marketing, Nothing)
        Ts_Tab_03_Marketing.Tag = "3"
        Ts_Tab_03_Marketing.Text = "Marketing"
        ' 
        ' Ts_Mkt_01_Benefits
        ' 
        Ts_Mkt_01_Benefits.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Mkt_01_Benefits.Dock = DockStyle.None
        Ts_Mkt_01_Benefits.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Mkt_01_Benefits.ForeColor = Color.MidnightBlue
        Ts_Mkt_01_Benefits.GripStyle = ToolStripGripStyle.Hidden
        Ts_Mkt_01_Benefits.Image = Nothing
        Ts_Mkt_01_Benefits.Items.AddRange(New ToolStripItem() {Mkt_Btn_01_Benefits_Promotions, Mkt_Btn_02_Benefits_Vouchers})
        ...
        ' 
        ' Mkt_Btn_01_Benefits_Promotions
        ' 
        Mkt_Btn_01_Benefits_Promotions.Font = New Font("Calibri", 11.25F)
        Mkt_Btn_01_Benefits_Promotions.Image = CType(resources.GetObject("Mkt_Btn_01_Benefits_Promotions.Image"), Image)
        Mkt_Btn_01_Benefits_Promotions.ImageScaling = ToolStripItemImageScaling.None
        Mkt_Btn_01_Benefits_Promotions.ImageTransparentColor = Color.Magenta
        ...
        ' 
        ' Mkt_Btn_02_Benefits_Vouchers
        ' 
        Mkt_Btn_02_Benefits_Vouchers.Font = New Font("Calibri", 11.25F)
        Mkt_Btn_02_Benefits_Vouchers.Image = CType(resources.GetObject("Mkt_Btn_02_Benefits_Vouchers.Image"), Image)
        Mkt_Btn_02_Benefits_Vouchers.ImageScaling = ToolStripItemImageScaling.None
        Mkt_Btn_02_Benefits_Vouchers.ImageTransparentColor = Color.Magenta
        ...
        ' Ts_Mkt_02_Loyalty
        ' 
        Ts_Mkt_02_Loyalty.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Mkt_02_Loyalty.Dock = DockStyle.None
        Ts_Mkt_02_Loyalty.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Mkt_02_Loyalty.ForeColor = Color.MidnightBlue
        ...
        ' 
        ' Mkt_Btn_03_Loyalty_Campaigns
        ' 
        Mkt_Btn_03_Loyalty_Campaigns.Font = New Font("Calibri", 11.25F)
        Mkt_Btn_03_Loyalty_Campaigns.Image = CType(resources.GetObject("Mkt_Btn_03_Loyalty_Campaigns.Image"), Image)
        Mkt_Btn_03_Loyalty_Campaigns.ImageScaling = ToolStripItemImageScaling.None
        Mkt_Btn_03_Loyalty_Campaigns.ImageTransparentColor = Color.Magenta
        ...
        ' 
        ' Mkt_Btn_04_Loyalty_Program
        ' 
        Mkt_Btn_04_Loyalty_Program.Font = New Font("Calibri", 11.25F)
        Mkt_Btn_04_Loyalty_Program.Image = CType(resources.GetObject("Mkt_Btn_04_Loyalty_Program.Image"), Image)
        Mkt_Btn_04_Loyalty_Program.ImageScaling = ToolStripItemImageScaling.None
        Mkt_Btn_04_Loyalty_Program.ImageTransparentColor = Color.Magenta
        ...
        ' 
        ' Mkt_Btn_05_Loyalty_Birthdays
        ' 
        Mkt_Btn_05_Loyalty_Birthdays.Font = New Font("Calibri", 11.25F)
        Mkt_Btn_05_Loyalty_Birthdays.Image = CType(resources.GetObject("Mkt_Btn_05_Loyalty_Birthdays.Image"), Image)
        Mkt_Btn_05_Loyalty_Birthdays.ImageScaling = ToolStripItemImageScaling.None
        Mkt_Btn_05_Loyalty_Birthdays.ImageTransparentColor = Color.Magenta
        ...
        ' Ts_Tab_04_Reports
        ' 
        Ts_Tab_04_Reports.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Tab_04_Reports.Name = "Ts_Tab_04_Reports"
        ' 
        ' RibbonControlAdv1.RibbonPanel4
        ' 
        Ts_Tab_04_Reports.Panel.Controls.Add(Ts_Report_01_Sales)
        Ts_Tab_04_Reports.Panel.Controls.Add(Ts_Report_02_Performance)
        Ts_Tab_04_Reports.Panel.Controls.Add(Ts_Report_03_Finance)
        Ts_Tab_04_Reports.Panel.Controls.Add(Ts_Report_04_Stock)
        Ts_Tab_04_Reports.Panel.Name = "RibbonPanel4"
        Ts_Tab_04_Reports.Panel.ScrollPosition = 0
        Ts_Tab_04_Reports.Panel.TabIndex = 5
        Ts_Tab_04_Reports.Panel.Text = "Reports"
        Ts_Tab_04_Reports.Position = 3
        Ts_Tab_04_Reports.Size = New Size(76, 25)
        RibbonControlAdv1.TabGroups.SetTabGroup(Ts_Tab_04_Reports, Nothing)
        Ts_Tab_04_Reports.Tag = "4"
        Ts_Tab_04_Reports.Text = "Reports"
        ' 
        ' Ts_Report_01_Sales
        ' 
        Ts_Report_01_Sales.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Report_01_Sales.Dock = DockStyle.None
        Ts_Report_01_Sales.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Report_01_Sales.ForeColor = Color.MidnightBlue
        Ts_Report_01_Sales.GripStyle = ToolStripGripStyle.Hidden
        Ts_Report_01_Sales.Image = Nothing
        ...
        ' 
        ' Ts_Report_02_Performance
        ' 
        Ts_Report_02_Performance.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Report_02_Performance.Dock = DockStyle.None
        Ts_Report_02_Performance.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Report_02_Performance.ForeColor = Color.MidnightBlue
        ...
        ' 
        Ts_Report_03_Finance.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Report_03_Finance.Dock = DockStyle.None
        Ts_Report_03_Finance.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Report_03_Finance.ForeColor = Color.MidnightBlue
        ...
        ' Ts_Report_04_Stock
        ' 
        Ts_Report_04_Stock.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Report_04_Stock.Dock = DockStyle.None
        Ts_Report_04_Stock.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Report_04_Stock.ForeColor = Color.MidnightBlue
        ...
        ' Ts_Tab_05_Config
        ' 
        Ts_Tab_05_Config.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Tab_05_Config.Name = "Ts_Tab_05_Config"
        ' 
        ' RibbonControlAdv1.RibbonPanel5
        ' 
        Ts_Tab_05_Config.Panel.Controls.Add(Ts_Config_01_Operational)
        Ts_Tab_05_Config.Panel.Controls.Add(Ts_Config_02_Personal)
        Ts_Tab_05_Config.Panel.Controls.Add(Ts_Config_03_General)
        Ts_Tab_05_Config.Panel.Name = "RibbonPanel5"
        Ts_Tab_05_Config.Panel.ScrollPosition = 0
        Ts_Tab_05_Config.Panel.TabIndex = 6
        Ts_Tab_05_Config.Panel.Text = "Config"
        Ts_Tab_05_Config.Position = 4
        Ts_Tab_05_Config.Size = New Size(67, 25)
        RibbonControlAdv1.TabGroups.SetTabGroup(Ts_Tab_05_Config, Nothing)
        Ts_Tab_05_Config.Tag = "5"
        Ts_Tab_05_Config.Text = "Config"
        ' 
        ' Ts_Config_01_Operational
        ' 
        Ts_Config_01_Operational.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Config_01_Operational.Dock = DockStyle.None
        Ts_Config_01_Operational.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Config_01_Operational.ForeColor = Color.MidnightBlue
        Ts_Config_01_Operational.GripStyle = ToolStripGripStyle.Hidden
        Ts_Config_01_Operational.Image = Nothing
        Ts_Config_01_Operational.Items.AddRange(New ToolStripItem() {Config_Btn_01_General_Tables, Config_Btn_02_General_Units})
        ...
        ' 
        Ts_Config_02_Personal.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Config_02_Personal.Dock = DockStyle.None
        Ts_Config_02_Personal.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Config_02_Personal.ForeColor = Color.MidnightBlue
        ...
        ' 
        ' Ts_Config_03_General
        ' 
        Ts_Config_03_General.CaptionFont = New Font("Calibri", 11.25F)
        Ts_Config_03_General.Dock = DockStyle.None
        Ts_Config_03_General.Font = New Font("Calibri", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Ts_Config_03_General.ForeColor = Color.MidnightBlue
        ...
        Ts_Tab_01_Main.Panel.ResumeLayout(False)
        Ts_Tab_01_Main.Panel.PerformLayout()
        Ts_Main_01_Cashier.ResumeLayout(False)
        Ts_Main_01_Cashier.PerformLayout()
        Ts_Main_02_Orders.ResumeLayout(False)
        Ts_Main_02_Orders.PerformLayout()
        Ts_Main_03_Reservation.ResumeLayout(False)
        Ts_Main_03_Reservation.PerformLayout()
        Ts_Main_04_Customers.ResumeLayout(False)
        Ts_Main_04_Customers.PerformLayout()
        Ts_Main_05_Logout.ResumeLayout(False)
        ...
        Ts_Mkt_01_Benefits.ResumeLayout(False)
        Ts_Mkt_01_Benefits.PerformLayout()
        Ts_Mkt_02_Loyalty.ResumeLayout(False)
        Ts_Mkt_02_Loyalty.PerformLayout()
        Ts_Tab_04_Reports.Panel.ResumeLayout(False)
        Ts_Tab_04_Reports.Panel.PerformLayout()
        ...
        Ts_Tab_05_Config.Panel.ResumeLayout(False)
        Ts_Tab_05_Config.Panel.PerformLayout()
        Ts_Config_01_Operational.ResumeLayout(False)
        Ts_Config_01_Operational.PerformLayout()
        Ts_Config_02_Personal.ResumeLayout(False)
        Ts_Config_02_Personal.PerformLayout()
        Ts_Config_03_General.ResumeLayout(False)
        Ts_Config_03_General.PerformLayout()
        ResumeLayout(False)
        PerformLayout()
    End Sub
    ...
    Friend WithEvents ToolStrip_Config As ToolStrip
    ...
    Friend WithEvents ToolStripButton18 As ToolStripDropDownButton
    ...
    Friend WithEvents Ts_Tab_01_Main As Syncfusion.Windows.Forms.Tools.ToolStripTabItem
    Friend WithEvents Ts_Main_01_Cashier As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Main_02_Orders As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Main_03_Reservation As Syncfusion.Windows.Forms.Tools.ToolStripEx
    ...
    Friend WithEvents Ts_Config_01_Operational As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Config_02_Personal As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Config_03_General As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Tab_03_Marketing As Syncfusion.Windows.Forms.Tools.ToolStripTabItem
    Friend WithEvents Ts_Mkt_01_Benefits As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Mkt_02_Loyalty As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Tab_04_Reports As Syncfusion.Windows.Forms.Tools.ToolStripTabItem
    Friend WithEvents Ts_Report_01_Sales As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Report_02_Performance As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Report_03_Finance As Syncfusion.Windows.Forms.Tools.ToolStripEx
    Friend WithEvents Ts_Report_04_Stock As Syncfusion.Windows.Forms.Tools.ToolStripEx
